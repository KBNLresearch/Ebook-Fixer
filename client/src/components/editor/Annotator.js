 ...
 *
 * @param {String[]} annotationList List of the annotations for this image
 * @param {external:SetStateAction} setTextValue Updates text value in user annotation box
 * @param {String} textValue Human annotation entered by user
 * @param {external:SetStateAction} setTyping Updates whether or not the user is typing
 * @component
...
function Annotator({ currImage, ebookId }) {
    ...
    const options = [{ abr: 'GOOGL', val: 'Google Vision API' }]
