 ...
 * @param {ImageInfo} currImage metadata for the image
 ...
 * @param {external:SetStateAction} setStage Sets the current stage in annotation processA
 * @component
...
function Classifier({
    ...
    useEffect(() => {
        if (!currImage) {
            ...
            if (currClassification != null) {
                ...
                const idx =
                    options.findIndex((opt) => opt.val === currClassification) +
                    1
    ...
    function handleSubmit() {
        if (currImage) {
            ...
            if (
                selectedClassification !== 'Decoration' &&
                selectedClassification !== 'Invalid'
            ) {
