 ...
 * @param {{setImageId: Updates image id stored on client, generated by server}} props The props of the component
 * @returns The AIannotator component
 */
function AIannotator({ currImage, ebookId, setImageId }) {
