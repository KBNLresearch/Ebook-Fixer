 ...
 * @param {SetStateAction} setAnnotationList Updates the list of human annotations
 ...
 * @param {SetStateAction} setImageId Updates image id
 * @param {String} existingAlt The existing alt-text of the image to display separately
 * @param {SetStateAction} setStage Sets the next stage in the image annotation process
 * @component
