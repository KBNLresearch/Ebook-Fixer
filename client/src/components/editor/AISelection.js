...
function AISelection({setStage, currAiSelected, setCurrAiSelected, setAiAnnotationList, setSentence, currImage, ebookId, imageId}) {
    ...
    /**
     * @param generatedAiImageSuggestions: List of Annotation objects generated by black box AI in the same step
     * Makes API call to server for fetching Yake keywords
     */
    function getYakeKeywords(generatedAiImageSuggestions) {

        // TODO: if Yake was fetched already, use that result
