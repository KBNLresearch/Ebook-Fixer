...
class Ebook(models.Model):
    ...
    # The files uploaded to FileField are not stored in the database but in the filesystem (under MEDIA_ROOT/...)
    # FileField is created as a string field in the database (usually VARCHAR), containing the reference to the actual file
